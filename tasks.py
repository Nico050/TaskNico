import pandas as pd
import os
from notify import task_created_email, task_deleted_email
...
def find_DB_tasks(cuser):
    if os.path.exists(f"{cuser['Username']}T.csv"):
        ...
        df = pd.DataFrame(columns=["Task_Name", "Task_Description", "Task_Priority", "Task_Status", "Task_Manager", "Task_Colaborators", "Task_Type", "Task_Recurring", "Task_Recurring_Dates", "Task_Recurring_Time", "Task_Dini", "Task_Tini", "Task_Dend", "Task_Tend"])
